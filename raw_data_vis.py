...
ax0.set_title('Cement Content vs Concrete Compressive Strength', fontsize=10)
...
ax1.set_title('Blast Furnace Slag vs Concrete Compressive Strength', fontsize=10)
...
ax2.set_title('Fly Ash vs Concrete Compressive Strength', fontsize=10)
ax2.set_xlabel('Fly Ash Content, kG/m^3')

ax3.scatter(np.asarray(x3, float), np.asarray(y, float), color = 'blue', s=None, label = "Water")
ax3.set_title('Water vs Concrete Compressive Strength', fontsize=10)
...
ax4.set_title('Superplasticizer vs Concrete Compressive Strength', fontsize=10)
...
ax5.set_title('Coarse Aggregate vs Concrete Compressive Strength', fontsize=10)
...
ax6.set_title('Fine Aggregate vs Concrete Compressive Strength', fontsize=10)
ax6.set_xlabel('Fine Aggregate, kG/m^3')

ax7.scatter(np.asarray(x7, float), np.asarray(y, float), color = 'black', s=None, label = "Age")
ax7.set_title('Age vs Concrete Compressive Strength', fontsize=10)
